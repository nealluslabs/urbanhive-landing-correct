          ...
          <Grid  container spacing={2}>
            ...
            <Grid item xs={12} sm container spacing={2}>
              <Grid item xs container direction="column" spacing={2}>
                <Grid   item xs>
                  <h2 style={{ fontSize: '19px'}}><b>Yoruba</b></h2>
                  <p style={{ fontSize: '16px'}}>Akin Adeyemi</p>
                </Grid>
              </Grid>
        ...
        >
          <Grid  container spacing={2}>
            ...
            <Grid item xs={12} sm container spacing={2}>
              <Grid item xs container direction="column" spacing={2}>
                <Grid  item xs>
                  <h2 style={{ fontSize: '19px'}}><b>Swahili</b></h2>
                  <p style={{ fontSize: '16px'}}> Asana Bakari</p>
                </Grid>
              </Grid>
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm container spacing={2}>
              <Grid item xs container direction="column" spacing={2}>
                <Grid  item xs>
                  <h2 style={{ fontSize: '19px'}}><b>Hausa</b></h2>
                  <p style={{ fontSize: '16px'}}>Mohammed Usman</p>
                </Grid>
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm container spacing={2}>
              <Grid item xs container direction="column" spacing={2}>
                <Grid  item xs>
                  <h2 style={{ fontSize: '19px'}}><b>Igbo</b></h2>
                  <p style={{ fontSize: '16px'}}>Chima Nwosu</p>
                </Grid>
              </Grid>
